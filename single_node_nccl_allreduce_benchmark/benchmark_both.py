...
def main():
    ...
    parser.add_argument("--mode",
                        choices=["naive", "ring", "rhd", "twoshot", "p2p", "p2p_nopa", "comp_p2p", "ringp2p", "compressed", "compressed_nosize", "all"],
                        default="naive",
    ...
    def unpack_row(row):
        ...
        cuda = {"naive": cuda_naive, "ring": cuda_ring, "rhd": cuda_rhd,
        ...
        wall = {"naive": wall_naive, "ring": wall_ring, "rhd": wall_rhd,
