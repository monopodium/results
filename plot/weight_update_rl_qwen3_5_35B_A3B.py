...
ax1.set_xticks(x)
ax1.set_xticklabels(labels, rotation=20, ha="right", fontsize=14)
...
ax1.legend(bars_handles + [line],
           ...
           loc="upper left", ncol=len(bars_labels_list) + 1)

plt.tight_layout()

output_dir = "/home/ubuntu/efs/shuangma/results/fig"
os.makedirs(output_dir, exist_ok=True)
plot_common.save_fig(output_dir, "weight_update_rl_qwen3_5_35B_A3B")
