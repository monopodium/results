...
# Read data from CSV
data_file = os.path.join(os.path.dirname(__file__), "../csv/p2p_split_send_vs_2baseline_float8_e5m2.csv")
...
plot_common.save_fig(output_dir, "p2p_split_send_vs_2baseline_float8_e5m2")
