...
csv_path = "/home/ubuntu/efs/shuangma/results/csv/weight_update_different_version.csv"
df = pd.read_csv(csv_path)
df.columns = [c.strip() for c in df.columns]

labels = [str(v) for v in df["Weights Version"]]
...
ax1.set_xticks(x)
ax1.set_xticklabels(labels, ha="right", fontsize=13)
...
ax1.legend([b1, b2, b3, line],
           ["Baseline", "Encode Send", "Split Send", "compression_ratio"],
...
plot_common.save_fig(output_dir, "weight_update_different_version")
